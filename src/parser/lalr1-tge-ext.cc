...
m4_include([parser/tempest-shader.m4])
...
[[    typedef YYSTYPE semantic_type;]])])[
    ...
    Tempest::LogStream& debug_stream ();
...
#define YYRECOVERING()  (!!yyerrstatus_)
  ...
  /// Build a parser object.
    ...
    :])[
      ...
      yycdebug_ (Tempest::Log::stream(TGE_LOG_DEBUG))]m4_ifset([b4_parse_param], [,])[
...
namespace Tempest { namespace AST {
